...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AACTools/speechmarkdown-rust/releases/download/v0.4.5/SpeechMarkdownRust.xcframework.zip",
            checksum: "7313d097117def931f5c00ec2aadde24b065488075e457adf9ecef05f1bfe49f"
        ),
        .target(
