...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AACTools/speechmarkdown-rust/releases/download/v0.4.12/SpeechMarkdownRust.xcframework.zip",
            checksum: "eaa8fb7235df4f3745767eac1e5849e0d0373bf3f421e9924c6de4adff4cedd4"
        ),
        .target(
