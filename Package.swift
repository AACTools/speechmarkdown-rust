...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AACTools/speechmarkdown-rust/releases/download/v0.4.14/SpeechMarkdownRust.xcframework.zip",
            checksum: "04a1874b86bb7034a2c39e4946abbc5dde9d8378d2167631163aecb5967cf4db"
        ),
        .target(
