...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AACTools/speechmarkdown-rust/releases/download/v0.2.5/SpeechMarkdownRust.xcframework.zip",
            checksum: "a9b335102d67e85b0b25572d98792e2a185443c971da6b25f3e6913ea68d5038"
        ),
        .target(
