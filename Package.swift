...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/AACTools/speechmarkdown-rust/releases/download/v0.2.4/SpeechMarkdownRust.xcframework.zip",
            checksum: "01deff3a7b7ac8bc6d1abaf1d68c37be2784452f538531465837a83a2eb7f800"
        ),
        .target(
